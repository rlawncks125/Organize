...
export class RoomService {
   ...
   * 내가 들어간방들 정보 ( myRooms )
   */
  static roomControllerMyRooms(options: IRequestOptions = {}): Promise<MyRoomsOutPutDto> {
    return new Promise((resolve, reject) => {
   ...
   * 방 목록 ( myRooms )
   */
  static roomControllerRoomList(options: IRequestOptions = {}): Promise<roomListOutPutDto> {
    return new Promise((resolve, reject) => {
